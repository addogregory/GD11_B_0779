package com.example.gd11_b_0779
...
class AddEditActivityTest {
    ...
    fun addEditActivityTest() {
        ...
        textInputEditText.perform(scrollTo(), replaceText("Addo"), closeSoftKeyboard())
        ...
        textInputEditText2.perform(scrollTo(), replaceText("200710779"), closeSoftKeyboard())
